...
export default function MarketplacePage() {
  ...
  const categories = ["All", "Cyberpunk", "Sci-Fi", "Fantasy", "Abstract", "Portrait", "Landscape"];
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto px-4">
              Discover and collect unique AI-generated artworks from talented creators around the world.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 px-4 sm:px-0">
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 transition-colors relative"
              >
                <Filter size={16} />
                Filters
              ...
              <select
                ...
                className="px-4 py-2 bg-background-light dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-900 dark:text-white"
              >
              ...
              {activeFiltersCount > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-red-500/10 text-red-500 rounded-lg hover:bg-red-500/20 transition-colors text-sm"
                >
                  <X size={14} />
                  Clear All
                </button>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {filters.free && (
                      <span className="inline-flex items-center gap-1 px-3 py-1 bg-primary/10 text-primary rounded-full text-sm">
                        Free
                        <button onClick={() => handleFilterChange('free', false)}>
                          <X size={14} />
                        </button>
                      </span>
                    )}
